...
CORPUS_EN_DIR = BASE_DIR / "data" / "corpus" / "en"
CORPUS_ZH_DIR = BASE_DIR / "data" / "corpus" / "zh"
...
def load_corpus(lang):
    """读取指定语言语料,lang = 'en' 或 'zh'。返回非空句子列表。

    支持两种放置方式(可同时使用):
    1. 单文件:data/corpus/{lang}.txt
    2. 目录:data/corpus/{lang}/ 下的所有 .txt 文件
    """
